...
public class CarsParser {
    ...
    private ArrayList<JsonObject> getFromFile()throws Exception {
        ...
        //TODO: see if can be done with no stream mode & TIDY UP comments
        try {
            reader = new BufferedReader(new FileReader("src/testData.json"));//Reads text from a character-input stream
            // An InputStreamReader is a bridge from byte streams to character streams
